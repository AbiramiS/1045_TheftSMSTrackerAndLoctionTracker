		...
		//  InetAddress ipAddress=null; 
	        /** Detects the default IP address of this host. */ 
	                /*try { 
	                       ...
	                       System.out.println("ip is"+ipAddress.toString()); 
	                        conn.close(); 
	                } catch (Exception e) { 
...
//				System.out.println(cursor.getString(11));
				new SmsSender(SharedValues.OG_MSG, cursor.getString(2), cursor.getString(cursor.getColumnIndexOrThrow("body")).toString()).start();
				System.out.println(cursor.getColumnIndexOrThrow("body"));
			} finally {
				cursor.close();
			}
		}
